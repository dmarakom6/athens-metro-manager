 ...
 * 
 * This class stores the game state (level, score, simulation data) and manages all
 * VisualAsset objects in the game. It provides the central init(), update(), and draw()
 * methods that coordinate all game objects.
 */
class GlobalState {
    ...
    private:
        ...
        // STL container to manage all visual assets (stations, trains, passengers, UI elements)
    ...
    public:
        ...
        // Delete copy constructor and assignment operator to prevent copying (singleton class)
    ...
    private:
         ...
         */
        GlobalState() : level(0), score(0), windowWidth(800), windowHeight(600) {}
